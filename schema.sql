...
CREATE TABLE `channelinfo` (
  ...
  `channelinfo` longblob,
  `channeltitle` longblob NOT NULL,
  `owner` bigint unsigned NOT NULL,
  `voicechannelid` bigint unsigned NOT NULL,
  `projectmessageid` bigint DEFAULT NULL,
...
CREATE TABLE `channeltag` (
  ...
  `tag` mediumblob NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `projectchannels`
--

DROP TABLE IF EXISTS `projectchannels`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `projectchannels` (
  `projectid` int unsigned NOT NULL,
  `channelid` bigint unsigned NOT NULL,
  `isvoice` tinyint unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-10-09  3:30:13
